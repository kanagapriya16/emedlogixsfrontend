...
import Codenotes1t from "./Codenotes1t";
import Sectionnotes1t from "./Sectionnotes1t";
...
export const Alphabett = ({ setSelectedCode }) => {
              ...
              <Box sx={{ width: "100%" }}>
                ...
                >
                  ...
                  <CustomTabPanel value={value} index={0}>
                    <Codenotes1t onCodeClick={setSelectedCode} />
                  </CustomTabPanel>
                  <CustomTabPanel value={value} index={1}>
                    <Sectionnotes1t onCodeClick={setSelectedCode} />
                  </CustomTabPanel>
